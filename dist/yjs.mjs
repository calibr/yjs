...
import { createEncoder, toUint8Array, writeVarUint, writeUint8, writeVarString, writeVarUint8Array } from 'lib0/encoding.js';
import { readVarUint, createDecoder, readVarString, readVarUint8Array, readUint8 } from 'lib0/decoding.js';
...
export { AbstractStruct, AbstractType, YArray as Array, ContentBinary, ContentDeleted, ContentEmbed, ContentFormat, ContentJSON, ContentString, ContentType, Doc, GC, ID, Item, YMap as Map, RelativePosition, Snapshot, YText as Text, Transaction, UndoManager, YXmlElement as XmlElement, YXmlFragment as XmlFragment, YXmlHook as XmlHook, YXmlText as XmlText, YArrayEvent, YEvent, YMapEvent, YXmlEvent, applyUpdate, compareIDs, compareRelativePositions, createAbsolutePositionFromRelativePosition, createID, createRelativePositionFromJSON, createRelativePositionFromTypeIndex, encodeStateAsUpdate, encodeStateVector, findRootTypeKey, getState, iterateDeletedStructs, readRelativePosition, typeListToArraySnapshot, typeMapGetSnapshot, writeRelativePosition };
