...
import { readVarUint, createDecoder, readVarString, readVarUint8Array, readAny, readUint8 } from 'lib0/decoding.js';
...
import { last } from 'lib0/array.js';
